      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg text-gray-600">
            Choose the best way to connect with your trusted expert.
          </p>
        </div>
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            <div
              key={service.name}
              className={`p-6 rounded-lg shadow-lg ${service.bg} flex flex-col items-center text-center`}
            >
              <div
                className={`flex-shrink-0 flex items-center justify-center h-16 w-16 rounded-full bg-white`}
              >
              ...
              <Link
                to={
                  service.name === 'DivyaVaani AI' ? '/divyavaani-ai-chat' : 'chat-with-astrologer'
                }
