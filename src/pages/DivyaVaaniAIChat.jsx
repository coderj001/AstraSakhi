    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-900">Converse with the Divine Within</h2>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {divineEntities.map((entity) => (
            ...
            >
              ...
              />
              <h3 className="mt-4 text-xl font-semibold text-gray-900">{entity.name}</h3>
              <p className="mt-2 text-base text-gray-700">{entity.description}</p>
