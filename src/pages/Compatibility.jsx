  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg text-center">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Are you compatible?</h1>
        <p className="text-gray-600 mb-6">
          Choose your and your partner's zodiac sign to check compatibility.
        </p>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="yourSign" className="block text-gray-700 font-medium mb-2">
              Your Sign
            </label>
            <select
              id="yourSign"
          ...
          <div className="mb-6">
            <label htmlFor="partnerSign" className="block text-gray-700 font-medium mb-2">
              Partner's Sign
            </label>
            <select
              id="partnerSign"
