...
const ReportSection = ({ report }) => {
   ...
   const ReportCard = ({ title, children, className = "" }) => (
      ...
      >
         <h3 className="text-xl font-bold text-purple-200 mb-4 border-b border-purple-200/20 pb-2">{title}</h3>
         <div className="text-purple-50 leading-relaxed">
            {children}
         </div>
      </motion.div>
   );
               ...
               <div className="space-y-1">
                  {chart.planet.map((planet, index) => (
                     <div key={index} className="flex justify-between text-sm">
                        <span className={`${chart.planet_retro.includes(planet) ? 'text-red-300' : 'text-purple-100'}`}>
   ...
   return (
      ...
      >
         <div className="text-center mb-10">
            ...
            <p className="text-purple-200/60">Prepared for <span className="text-white font-semibold">{user.name}</span></p>
         </div>
      ...
      <div className="container mx-auto px-4 py-12">
         ...
         >
            ...
            <p className="text-lg text-purple-100/80 max-w-2xl mx-auto leading-relaxed">
               Unlock the secrets of your destiny. Generate your detailed birth chart and get instant insights into your life path.
            </p>
         </motion.div>
         ...
         >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-2">
                     <label htmlFor="gender" className="text-sm font-semibold text-purple-100 tracking-wide uppercase">
                        Gender
                     </label>
