  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      ...
      <p className='text-center text-gray-600 mb-8'>
        Have you ever thought, “Are we made for each other?” That’s where Kundli
        matching comes in. It's been a trusted way for Indian families to find
        the right life partner for generations. This method uses the age-old
        science of astrology to see if two people are truly compatible for a
