...
const KundliForm = ({
   ...
   return (
      ...
      >
         ...
         <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-200 to-pink-200 mb-8 text-center">{title}</h2>
         <form>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <div className="space-y-2">
                  <label htmlFor="name" className="text-sm font-semibold text-purple-100 tracking-wide uppercase">
                     Name
                  </label>
                  <input
                     type="text"
               ...
               <div className="space-y-2">
                  <label htmlFor="dob" className="text-sm font-semibold text-purple-100 tracking-wide uppercase">
                     Date of Birth
                  </label>
                  <input
                     type="date"
               ...
               <div className="space-y-2">
                  <label htmlFor="tob" className="text-sm font-semibold text-purple-100 tracking-wide uppercase">
                     Time of Birth
                  </label>
                  <input
                     type="time"
               ...
               <div className="space-y-2">
                  <label htmlFor="pob" className="text-sm font-semibold text-purple-100 tracking-wide uppercase">
                     Birth Place
                  </label>
                  <Autocomplete
      ...
      <div className="container mx-auto px-4 py-8">
         ...
         <ResultCard title="Basic Details">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                  <h3 className="text-xl font-semibold mb-4 text-purple-200 border-b border-white/10 pb-2">Boy's Details</h3>
                  <div className="space-y-2 text-purple-100/80">
                     <p><strong className="text-purple-200">Date of Birth:</strong> {boy.dob}</p>
                     <p><strong className="text-purple-200">Time of Birth:</strong> {boy.tob}</p>
                     <p><strong className="text-purple-200">Place of Birth:</strong> {boy.pob}</p>
                  </div>
               </div>
               <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                  <h3 className="text-xl font-semibold mb-4 text-purple-200 border-b border-white/10 pb-2">Girl's Details</h3>
                  <div className="space-y-2 text-purple-100/80">
                     <p><strong className="text-purple-200">Date of Birth:</strong> {girl.dob}</p>
                     <p><strong className="text-purple-200">Time of Birth:</strong> {girl.tob}</p>
                     <p><strong className="text-purple-200">Place of Birth:</strong> {girl.pob}</p>
                  </div>
               </div>
            </div>
         </ResultCard>
         ...
         <ResultCard title="Summary of the Kundli Report">
            <div className="flex flex-col items-center justify-center py-6">
               ...
               <p className="text-center text-xl text-purple-100 leading-relaxed max-w-2xl">{ashtkoot.conclusion.report}</p>
            </div>
         </ResultCard>
                  ...
                  <tbody className="divide-y divide-purple-200/10">
                     {ashtkootPoints.map(([key, value]) => (
                        ...
                        >
                           ...
                           <td className="flex justify-between md:table-cell py-3 px-4 text-purple-200/80" data-label="Out of">
         ...
         <div className="max-w-3xl mx-auto">
            <div className="flex justify-center mb-8 bg-white/5 p-1 rounded-xl backdrop-blur-sm inline-flex mx-auto w-full md:w-auto">
               <button
                  ...
                  className={`flex-1 md:flex-none px-8 py-3 text-lg font-medium rounded-lg transition-all duration-300 ${activeTab === 'boy'
               ...
               <button
                  ...
                  className={`flex-1 md:flex-none px-8 py-3 text-lg font-medium rounded-lg transition-all duration-300 ${activeTab === 'girl'
