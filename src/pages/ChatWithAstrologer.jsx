    ...
    <div className="bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Chat with an Astrologer</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Connect with our expert astrologers and get instant guidance on your life, career, and
            relationships.
          </p>
        </div>
